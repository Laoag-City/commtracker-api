...
const recipientSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    default: 'pending',
    enum: ['pending', 'approved', 'noted', 'in-progress', 'rejected', 'forwarded']
  }
}, {
  timestamps: true
});
...
const trackerSchema = new mongoose.Schema({
  ...
  lceAction: { type: String, enum: ['pending', 'approved', 'disapproved', 'for your comments', 'for review', 'for dissemination', 'for compliance', 'pls facilitate', 'noted', 'check availability of fund', 'others'], required: false },
