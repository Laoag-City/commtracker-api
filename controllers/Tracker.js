...
const commTrackersController = {
  ...
  updateRecipientByTrackerId: async (req, res) => {
    try {
      ...
      const allowedStatuses = ['for compliance', 'pls facilitate', 'rejected', 'pending', 'approved', 'disapproved', 'for your comments', 'for review', 'for dissemination', 'noted', 'check availability of fund', 'others'];
